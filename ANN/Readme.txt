Banco da europa, mediu tudo sobre os clientes.
O importante é saber se a pessoa saiu ou não do banco após um determinado tempo (Coluna "Exited");
Após observar isso, identificar quais pessoas tem mais chance de saírem do banco.
...
Parte 1 - Pre processamento de dados
...
Ja o nosso resultado será descrito comom Y, que corresponde a 13a coluna do dataset.
